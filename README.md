...
| Stable/common | `TcpHeartbeatSettings` | TCP heartbeat scheduling configuration. | When applications need periodic provider-generated bytes for keep-alive or advisory probes. |
